...
def main(*args, **kwargs):
    ...
    with open(file_path, encoding="utf8") as file:
        ...
        try:
            xml_rudoc[2] = xml_dict['extract_base_params_car_parking_space']['details_statement']['group_top_requisites']['registration_number']
        except:
            xml_rudoc[2] = ''
        try:
            xml_rudoc[3] = xml_dict['extract_base_params_car_parking_space']['details_statement']['group_top_requisites']['date_formation']
        except:
            xml_rudoc[3] = ''
        try:
            value = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['object']['common_data']['type']['value']
            if value == "car_parking_space_record":
                xml_rudoc[4] = "Сооружение"
        except:
            xml_rudoc[4] = ''
        try:
            dt = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['record_info']['registration_date'] # 2012-07-05T00:00:00+04:00
            ...
            xml_rudoc[5] = ''
        try:
            xml_rudoc[6] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['object']['common_data']['cad_number']
        except:
            xml_rudoc[6] = ''
        try:
            xml_rudoc[7] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['object']['common_data']['quarter_cad_number']
        except:
            xml_rudoc[7] = ''
        try:
            old_numbers = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['cad_links']['old_numbers']["old_number"]
            ...
            xml_rudoc[8] = ''
        try:
            xml_rudoc[9] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['address_location']['address']['readable_address']
        except:
            xml_rudoc[9] = ''
        try:
            xml_rudoc[10] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['base_parameters']['base_parameter']['area']
        except:
            xml_rudoc[10] = ''
        try:
            xml_rudoc[11] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['purpose']
        except:
            xml_rudoc[11] = ''
        try:
            xml_rudoc[12] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['name']
        except:
            xml_rudoc[12] = ''

        try:
            xml_rudoc[13] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['location_in_build']['level']['floor']
        except:
            xml_rudoc[13] = ''
        try:
            xml_rudoc[14] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['type']['value']
        except:
            xml_rudoc[14] = ''

        try:
            xml_rudoc[15] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['cost']['value']
        except:
            xml_rudoc[15] = ''
        try:
            land_cad_numbers = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['cad_links']['land_cad_numbers']['land_cad_number']
        ...
        try:
            print(xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['permitted_uses'])
            land_cad_numbers = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['params']['permitted_uses']
        ...
        try:
            xml_rudoc[18] = xml_dict ['extract_base_params_car_parking_space']['car_parking_space_record']['params']['special_type']['value']
        except:
            xml_rudoc[18] = ''


        try:
            xml_rudoc[19] = xml_dict['extract_base_params_car_parking_space']['status']
        except:
            xml_rudoc[19] = ''
        try:
            xml_rudoc[20] = xml_dict['extract_base_params_car_parking_space']['car_parking_space_record']['special_notes']
        except:
            xml_rudoc[20] = ''
        try:
            right_records = xml_dict['extract_base_params_car_parking_space']['right_records']
        ...
        # try:
        #     rights = xml_dict['extract_base_params_car_parking_space']['ownerless_right_records']
